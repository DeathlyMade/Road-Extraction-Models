...
from keras.layers import Conv2D, MaxPooling2D, Dropout, UpSampling2D, Concatenate, concatenate, add, Input
...
def res_unet(input_shape = (256,256,3)): #含有三个下采样残差单元的ResUnet
